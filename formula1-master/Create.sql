...
create table pilotos(id int primary key auto_increment, nome varchar(255), altura decimal(9,2), peso decimal(9,2), dt_nascimento date, id_pais varchar(3), id_equipe int, numero_carro int, foreign key(id_pais) references paises(sigla), foreign key(id_equipe) references equipes(id)) engine=InnoDB default charset=utf8;
